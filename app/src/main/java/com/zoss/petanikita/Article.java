...
public class Article extends RecyclerView.Adapter<Article.ArticleViewHolder> {

    private String[] articleTitles;
    private int[] articleImages;
    private String[] articleContents;

    public Article(String[] articleTitles, int[] articleImages, String[] articleContents) {
